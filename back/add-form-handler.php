            ...
            if ($_FILES['project_picture']['error']) {     
                ...
                // if everything is ok, try to upload file
                    ...
                    if (move_uploaded_file($_FILES["project_picture"]["tmp_name"], $target_file)) {
                        ...
                        $sql ="INSERT INTO projects (project_title,project_begin,project_end,project_context,project_specs, project_githublink,project_link, project_picture) VALUES(:project_title,:project_begin,:project_end,:project_context,:project_specs,:project_githublink,:project_link,:project_picture)";
